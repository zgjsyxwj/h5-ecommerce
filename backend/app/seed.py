...
ORDER_SEED_DATA = [
    ...
    },
    {
        ...
        "logistics": {
            ...
            "current_status": "运输中",
            "tracking_history": [
                {"timestamp": "2026-04-22T11:00:00", "status": "已下单", "location": "北京",         "description": "订单已创建"},
                {"timestamp": "2026-04-23T15:00:00", "status": "已发货",      "location": "北京发货中心", "description": "已从仓库发出"},
                {"timestamp": "2026-04-24T09:00:00", "status": "运输中",   "location": "天津转运中心", "description": "运输中"},
            ],
        },
    },
    {
        ...
        "logistics": {
            ...
            "current_status": "已签收",
            "tracking_history": [
                {"timestamp": "2026-04-10T08:30:00", "status": "已下单", "location": "上海",          "description": "订单已创建"},
                {"timestamp": "2026-04-11T10:00:00", "status": "已发货",      "location": "上海发货中心",  "description": "已从仓库发出"},
                {"timestamp": "2026-04-12T18:20:00", "status": "运输中",   "location": "上海市浦东新区", "description": "派送中"},
                {"timestamp": "2026-04-13T11:00:00", "status": "已签收",    "location": "上海市浦东新区", "description": "已签收"},
            ],
        },
    },
    {
        ...
        "logistics": {
            ...
            "current_status": "已发货",
            "tracking_history": [
                {"timestamp": "2026-04-23T14:00:00", "status": "已下单", "location": "广州",         "description": "订单已创建"},
                {"timestamp": "2026-04-24T09:30:00", "status": "已发货",      "location": "广州发货中心", "description": "已从仓库发出"},
            ],
        },
    },
    {
        ...
        "logistics": {
            ...
            "current_status": "已签收",
            "tracking_history": [
                {"timestamp": "2026-04-12T16:00:00", "status": "已下单", "location": "广州",         "description": "订单已创建"},
                {"timestamp": "2026-04-13T10:30:00", "status": "已发货",      "location": "广州发货中心", "description": "已从仓库发出"},
                {"timestamp": "2026-04-14T14:00:00", "status": "运输中",   "location": "深圳转运中心", "description": "运输中"},
                {"timestamp": "2026-04-16T09:45:00", "status": "已签收",    "location": "广州市天河区", "description": "已签收"},
            ],
        },
    },
]
